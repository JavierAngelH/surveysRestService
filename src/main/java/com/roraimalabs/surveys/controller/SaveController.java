...
public class SaveController {
	...
	public String getSurvey(@RequestParam(value = "id") long id, @RequestParam(value = "survey") String survey)
		...
		this.accessService.saveRecords(id, survey, RecordType.SURVEY);

		return "success";
	}

	@RequestMapping("/saveObservation")
	public String getObservation(@RequestParam(value = "id") long id,
			@RequestParam(value = "observation") String observation) throws ParseException {

		this.accessService.saveRecords(id, observation, RecordType.OBSERVATION);
